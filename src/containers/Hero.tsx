...
export function Hero() {
  return (
    <div id="hero" className="flex flex-col min-h-[43dvh] w-[24rem] pl-24 justify-end font-mono font-bold">
      <div>
      ...
      <Link activeClass="active" to="aboutMe" spy={true} smooth={true} offset={-45} duration={800}
